...
export default function About() {
  ...
  return (
    <>
      <Head>
        <title>About Us | Shree Venkatesh Enterprises</title>
        <meta name="description" content="Learn about Shree Venkatesh Enterprises, a leading MEP solutions provider with over 15 years of industry experience." />
      </Head>
